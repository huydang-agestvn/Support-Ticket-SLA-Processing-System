...
func TestTicket_ValidateRoomAndFloor(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "Invalid: Numbered room 002 on Floor 18",
			title:       "AC broken in room 002 on Floor 18",
			description: "The air conditioner in room 002 is not cooling at all, please send a technician.",
			expectError: true,
			errorMsg:    "room and floor mismatch: room '002' is not compatible with floor '18'",
		},
		{
			name:        "Invalid: Numbered room 004 on Floor 18",
			title:       "AC broken in room 004 on Floor 18",
			description: "The air conditioner in room 004 is not cooling at all, please send a technician.",
			expectError: true,
			errorMsg:    "room and floor mismatch: room '004' is not compatible with floor '18'",
		},
		{
			name:        "Invalid: Dynamic named room dev009 on Floor 12A",
			title:       "Severe water leak coming from the ceiling in Floor 12A",
			description: "We are completely out of paper cups in dev009 Floor 12A. Please restock them.",
			expectError: true,
			errorMsg:    "room and floor mismatch: room 'dev009' is not compatible with floor '12a'",
		},
		{
			name:        "Invalid: Dynamic named room dev0039 on Floor 18",
			title:       "Restock paper cups in dev0039 on Floor 18",
			description: "We are completely out of paper cups in dev0039 on Floor 18. Please restock them.",
			expectError: true,
			errorMsg:    "room and floor mismatch: room 'dev0039' is not compatible with floor '18'",
		},
		{
